...
public sealed class UtilitiesLogger : ILogging
{
    ...
    public string Dumper(params KeyValuePair<string, object?>[] values) => Utilities.Dumper(values);
    ...
    public bool IsNativeDebugEnabled() => Utilities.IsNativeDebugEnabled();
    ...
    public string GetVersion() => Utilities.GetVersion();
    ...
    public string HumanizeBytes(long bytes) => Utilities.HumanizeBytes(bytes);
}
